...
struct MGData_STRUCT {
  ...
  Vector<x_type> * xc; // coarse grid solution vector
 ...
 */
inline void InitializeMGData(local_int_t * f2cOperator, Vector<double> * rc, Vector<x_type> * xc, Vector<double> * Axf, MGData & data) {
