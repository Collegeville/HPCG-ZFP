...
int ComputeDotProduct(const local_int_t n, const Vector<T> & x, const Vector<U> & y,
 ...
 T * xv = (T*)x.optimizationData;
 U * yv = (U*)y.optimizationData;
 if (std::is_same<T, U>::value && (void*)yv==(void*)xv) {
#ifndef HPCG_NO_OPENMP
