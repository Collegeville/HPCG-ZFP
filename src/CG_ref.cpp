...
/*!
  ...
  @see CG()
*/
int CG_ref(const SparseMatrix & A, CGData & data, const Vector<b_type> & b, Vector<x_type> & x,
...
//#endif
  ...
  Vector<double> & z = data.z; // Preconditioned residual vector
  Vector<double> & p = data.p; // Direction vector (in MPI mode ncol>=nrow)
